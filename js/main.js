...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (chatToggle && chatWindow) {
    ...
    const kb = {
      ...
      bayliner: "The 2026 Bayliner Element E21 is available for $800 / all day. Delivery available to all 4 lakes. A premium 21ft boat perfect for families and groups. Fits up to 8 passengers!",
